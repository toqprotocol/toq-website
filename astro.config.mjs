...
export default defineConfig({
  integrations: [starlight({
			...
			head: [
				...
				{ tag: 'script', content: 'var from=sessionStorage.getItem("toq-from");sessionStorage.setItem("toq-from","docs");if(from==="landing"){document.documentElement.style.opacity="0";setTimeout(()=>{document.documentElement.style.transition="opacity 0.2s ease-in-out";document.documentElement.style.opacity="1"},50)}addEventListener("pagehide",()=>{document.documentElement.style.transition="none";document.documentElement.style.opacity="0"});addEventListener("pageshow",(e)=>{if(e.persisted){setTimeout(()=>{document.documentElement.style.transition="opacity 0.2s ease-in-out";document.documentElement.style.opacity="1"},50)}});addEventListener("DOMContentLoaded",()=>{var t=document.querySelector(".site-title");if(t){var a=t.closest("a");if(a)a.addEventListener("click",e=>{e.preventDefault();document.documentElement.style.transition="opacity 0.2s ease-in-out";document.documentElement.style.opacity="0";setTimeout(()=>{window.location.href="/"},200)})}})' },
			],
